...
public class AAXUnlock implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            XposedHelpers.findAndHookMethod(
                InstallSourceInfo.class, "getInitiatingPackageName", new XC_MethodHook() {
            ...
            XposedHelpers.findAndHookMethod(
                PackageManager.class, "getInstallerPackageName", new XC_MethodHook() {
